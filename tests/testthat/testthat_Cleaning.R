...
test_that("eq_good_date is making dates correctly",{
    expect_equal(capstoneR:::eq_good_date(2017,7,1),
                 ymd("2017-07-01"))
})
...
test_that("eq_location_clean is stripping out the countries and fixing case",{
    ...
    expect_equal(capstoneR:::eq_location_clean("USA: sAn fRancisco"),
                 "San Francisco")
})

test_that("title_case is working as advertised",{
    expect_equal(capstoneR:::title_case("this is not title case"),
